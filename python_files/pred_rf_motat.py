...
def load_data(file_name_list):
    master_df = pd.read_csv(file_name_list[0],nrows=83222)
...
train_master.to_csv("train_set_motat.csv")
fpf = os.path.join("/Users/neilkumar/Desktop/Python/Oceanum","train_set_motat.csv" )
if os.path.isfile(fpf):
    pass
else:
    train_master.to_csv("train_set_motat.csv")
...
fpf = os.path.join("/Users/neilkumar/Desktop/Python/Oceanum","test_set_,motat.csv" )
if os.path.isfile(fpf):
    pass
else:
    test_master.to_csv("test_set_motat.csv")
...
def int_feats(train_num, test_num):
    ...
    train_num['P_grad_motat_man'] = train_num['Mean sea level pressure [Hpa]'] - train_num['Sea_level_pressure_manukau_heads_pressure']
    train_num['P_grad_motat_mang'] = train_num['Mean sea level pressure [Hpa]'] - train_num['Sea_level_pressure_mangere_pressure']
    train_num['P_grad_motat_alb'] = train_num['Mean sea level pressure [Hpa]'] - train_num['Sea_level_pressure_albany_pressure']
    test_num['P_grad_motat_man'] = test_num['Mean sea level pressure [Hpa]'] - test_num['Sea_level_pressure_manukau_heads_pressure']
    test_num['P_grad_motat_mang'] = test_num['Mean sea level pressure [Hpa]'] - test_num['Sea_level_pressure_mangere_pressure']
    test_num['P_grad_motat_alb'] = test_num['Mean sea level pressure [Hpa]'] - test_num['Sea_level_pressure_albany_pressure']
    train_num['P_grad_motat_man_t'] = (train_num['Mean sea level pressure [Hpa]'] - train_num['Sea_level_pressure_manukau_heads_pressure'])/6
    train_num['P_grad_motat_mang_t'] = (train_num['Mean sea level pressure [Hpa]'] - train_num['Sea_level_pressure_mangere_pressure lag: 6'])/6
    train_num['P_grad_motat_alb_t'] = (train_num['Mean sea level pressure [Hpa]'] - train_num['Sea_level_pressure_albany_pressure lag: 3'])/3
    test_num['P_grad_motat_man_t'] = (test_num['Mean sea level pressure [Hpa]'] - test_num['Sea_level_pressure_manukau_heads_pressure lag: 3'])/3
    test_num['P_grad_motat_mang_t'] = (test_num['Mean sea level pressure [Hpa]'] - test_num['Sea_level_pressure_mangere_pressure lag: 6'])/6
    test_num['P_grad_motat_alb_t'] = (test_num['Mean sea level pressure [Hpa]'] - test_num['Sea_level_pressure_albany_pressure lag: 3'])/3
    test_num['dewtemp'] = test_num['dewpoint (degC)'] * test_num['Mean Temperature [Deg C]']
...
lag_feat = ["Rainfall [mm]", "Mean sea level pressure [Hpa]", "Mean Relative Humidity [percent]",
            ...
            "Rainfall_albany_rain","Speed_manukau_heads_wind", "Speed_mangere_wind",
            "Speed_albany_wind", "Sea_level_pressure_mangere_pressure",
            "Sea_level_pressure_albany_pressure", "Sea_level_pressure_manukau_heads_pressure"]
roll_feat = lag_feat

pressure_list = ["Sea_level_pressure_albany_pressure", "Sea_level_pressure_mangere_pressure","Sea_level_pressure_manukau_heads_pressure"]
lag_list = ["Sea_level_pressure_mangere_pressure lag: 6","Sea_level_pressure_albany_pressure lag: 6", "Sea_level_pressure_manukau_heads_pressure lag: 6"]
...
reg_imp.to_csv("regimp_motat.csv")
...
class_imp.to_csv("classimp_motat.csv")
...
test_master.to_csv("csv_motat_for_dash")
